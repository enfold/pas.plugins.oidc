...
from pas.plugins.oidc.plugins.group import KeycloakGroupsPlugin
from pas.plugins.oidc.utils import setup as utils
...
class TestUtilsSetup:
    ...
    @pytest.mark.parametrize(
        "plugin_id,interface,move_to_top",
        [
            ["invalid_plugin", "IChallengePlugin", True],
    ...
    @pytest.mark.parametrize(
        "plugin_id,interface",
        [
            ["invalid_plugin", "IChallengePlugin"],
